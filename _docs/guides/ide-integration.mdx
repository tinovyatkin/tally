...
<Tabs>
  <Tab title="Stack-aware diagnostics">
    <Frame caption="Tally identifies Composer, OPcache, Xdebug, and package-cache issues in PhpStorm.">
      ![PhpStorm showing Tally diagnostics for Composer production dependencies, OPcache, Xdebug, and package cache mounts](/images/integrations/tally-phpstorm-diagnostics.png)
    </Frame>
  </Tab>
  <Tab title="Quick fixes">
    <Frame caption="Use Alt+Enter to apply a fix, suppress a rule, or open its documentation.">
      ![PhpStorm intention menu showing Tally quick fixes and documentation actions for PHP Dockerfile rules](/images/integrations/tally-phpstorm-quick-fixes.png)
    </Frame>
  </Tab>
  <Tab title="RubyMine">
    <Frame caption="Tally identifies Bundler deployment, Rails asset compilation, health-check, and YJIT issues in RubyMine.">
      ![RubyMine showing Tally diagnostics for Bundler deployment mode, Rails asset compilation, health checks, and YJIT](/images/integrations/tally-rubymine-diagnostics.png)
    </Frame>
  </Tab>
</Tabs>
