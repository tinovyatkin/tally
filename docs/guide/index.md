...
Learn how to use tally effectively.

## Getting Started

- [Installation](./installation.md) - Install tally via Homebrew, npm, pip, or Go
...
- [AI AutoFix (ACP)](./ai-autofix-acp.md) - Use ACP agents for complex fixes (opt-in)
