...
tally supports **14/22** BuildKit checks:

- **5** captured during parsing
- **9** reimplemented by tally (BuildKit normally runs these during LLB conversion)
- **8** not currently supported (LLB conversion only)
- **9** with auto-fixes (🔧)
