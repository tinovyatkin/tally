...
tally supports **18/22** BuildKit checks:

- **5** captured during parsing
- **13** reimplemented by tally (BuildKit normally runs these during LLB conversion)
- **4** not currently supported (LLB conversion only)
- **10** with auto-fixes (🔧)
