...
tally supports **15/22** BuildKit checks:

- **5** captured during parsing
- **10** reimplemented by tally (BuildKit normally runs these during LLB conversion)
- **7** not currently supported (LLB conversion only)
- **9** with auto-fixes (🔧)
