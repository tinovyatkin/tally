...
func TestCheck_RelativeWithoutAbsolute(t *testing.T) {
	r := New()
...
func TestCheck_AbsoluteFirst(t *testing.T) {
	r := New()
...
func TestCheck_OnlyAbsolute(t *testing.T) {
	r := New()
...
func TestCheck_MultipleRelativeBeforeAbsolute(t *testing.T) {
	r := New()
