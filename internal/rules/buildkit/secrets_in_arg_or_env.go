...
// NewSecretsInArgOrEnvRule creates a new SecretsUsedInArgOrEnv rule instance.
...
func (r *SecretsInArgOrEnvRule) createViolation(loc rules.Location, instruction, key string) rules.Violation {
